...
export interface NFTKEYMarketplaceRoyaltyContract
  extends Truffle.Contract<NFTKEYMarketplaceRoyaltyInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<NFTKEYMarketplaceRoyaltyInstance>;
}
...
type AllEvents = OwnershipTransferred | SetRoyalty;

export interface NFTKEYMarketplaceRoyaltyInstance
